...
function serialize_organizations_CreateOrganizationRequest(arg) {
  if (!(arg instanceof organizations_pb.CreateOrganizationRequest)) {
...
function deserialize_organizations_CreateOrganizationRequest(buffer_arg) {
  return organizations_pb.CreateOrganizationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_organizations_DeleteOrganizationRequest(arg) {
  if (!(arg instanceof organizations_pb.DeleteOrganizationRequest)) {
...
function deserialize_organizations_DeleteOrganizationRequest(buffer_arg) {
  return organizations_pb.DeleteOrganizationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_organizations_GetOrganizationRequest(arg) {
  if (!(arg instanceof organizations_pb.GetOrganizationRequest)) {
...
function deserialize_organizations_GetOrganizationRequest(buffer_arg) {
  return organizations_pb.GetOrganizationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_organizations_ListOrganizationsRequest(arg) {
  if (!(arg instanceof organizations_pb.ListOrganizationsRequest)) {
...
function deserialize_organizations_ListOrganizationsRequest(buffer_arg) {
  return organizations_pb.ListOrganizationsRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_organizations_ListOrganizationsResponse(arg) {
  if (!(arg instanceof organizations_pb.ListOrganizationsResponse)) {
...
function deserialize_organizations_ListOrganizationsResponse(buffer_arg) {
  return organizations_pb.ListOrganizationsResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_organizations_Organization(arg) {
  if (!(arg instanceof organizations_pb.Organization)) {
...
function deserialize_organizations_Organization(buffer_arg) {
  return organizations_pb.Organization.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_organizations_UpdateOrganizationRequest(arg) {
  if (!(arg instanceof organizations_pb.UpdateOrganizationRequest)) {
...
function deserialize_organizations_UpdateOrganizationRequest(buffer_arg) {
  return organizations_pb.UpdateOrganizationRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var OrganizationsService = exports.OrganizationsService = {
  list: {
    ...
    requestType: organizations_pb.ListOrganizationsRequest,
    responseType: organizations_pb.ListOrganizationsResponse,
  ...
  get: {
    ...
    responseType: organizations_pb.Organization,
  ...
  create: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: organizations_pb.CreateOrganizationRequest,
    responseType: organizations_pb.Organization,
  ...
  update: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: organizations_pb.UpdateOrganizationRequest,
    responseType: organizations_pb.Organization,
  ...
  delete: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: organizations_pb.DeleteOrganizationRequest,
