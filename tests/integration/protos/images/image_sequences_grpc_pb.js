...
var images_image_sequences_pb = require('../images/image_sequences_pb.js');
...
function serialize_image_sequences_CreateImageSequenceRequest(arg) {
  if (!(arg instanceof images_image_sequences_pb.CreateImageSequenceRequest)) {
...
function deserialize_image_sequences_CreateImageSequenceRequest(buffer_arg) {
  return images_image_sequences_pb.CreateImageSequenceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_image_sequences_DeleteImageSequenceRequest(arg) {
  if (!(arg instanceof images_image_sequences_pb.DeleteImageSequenceRequest)) {
...
function deserialize_image_sequences_DeleteImageSequenceRequest(buffer_arg) {
  return images_image_sequences_pb.DeleteImageSequenceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_image_sequences_GetImageSequenceRequest(arg) {
  if (!(arg instanceof images_image_sequences_pb.GetImageSequenceRequest)) {
...
function deserialize_image_sequences_GetImageSequenceRequest(buffer_arg) {
  return images_image_sequences_pb.GetImageSequenceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_image_sequences_ImageSequence(arg) {
  if (!(arg instanceof images_image_sequences_pb.ImageSequence)) {
...
function deserialize_image_sequences_ImageSequence(buffer_arg) {
  return images_image_sequences_pb.ImageSequence.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_image_sequences_ListImageSequencesRequest(arg) {
  if (!(arg instanceof images_image_sequences_pb.ListImageSequencesRequest)) {
...
function deserialize_image_sequences_ListImageSequencesRequest(buffer_arg) {
  return images_image_sequences_pb.ListImageSequencesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_image_sequences_ListImageSequencesResponse(arg) {
  if (!(arg instanceof images_image_sequences_pb.ListImageSequencesResponse)) {
...
function deserialize_image_sequences_ListImageSequencesResponse(buffer_arg) {
  return images_image_sequences_pb.ListImageSequencesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_image_sequences_UpdateImageSequenceRequest(arg) {
  if (!(arg instanceof images_image_sequences_pb.UpdateImageSequenceRequest)) {
...
function deserialize_image_sequences_UpdateImageSequenceRequest(buffer_arg) {
  return images_image_sequences_pb.UpdateImageSequenceRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var ImageSequencesService = exports.ImageSequencesService = {
  list: {
    ...
    requestType: images_image_sequences_pb.ListImageSequencesRequest,
    responseType: images_image_sequences_pb.ListImageSequencesResponse,
  ...
  get: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: images_image_sequences_pb.GetImageSequenceRequest,
    responseType: images_image_sequences_pb.ImageSequence,
  ...
  create: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: images_image_sequences_pb.CreateImageSequenceRequest,
    responseType: images_image_sequences_pb.ImageSequence,
  ...
  update: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: images_image_sequences_pb.UpdateImageSequenceRequest,
    responseType: images_image_sequences_pb.ImageSequence,
  ...
  delete: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: images_image_sequences_pb.DeleteImageSequenceRequest,
