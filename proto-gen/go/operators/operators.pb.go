...
type Operator struct {
	...
	ParameterRoot []byte   `protobuf:"bytes,7,opt,name=parameter_root,json=parameterRoot,proto3" json:"parameter_root,omitempty"`
}
...
func (m *Operator) GetParameterRoot() []byte {
	if m != nil {
...
func (*RenderParameterRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
...
func (*RenderParameter) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{10} }
...
func init() {
	...
	proto.RegisterType((*RenderParameterRequest)(nil), "operators.RenderParameterRequest")
	proto.RegisterType((*RenderParameter)(nil), "operators.RenderParameter")
}
...
func (c *operatorsClient) GetRenderParameters(ctx context.Context, in *RenderParameterRequest, opts ...grpc.CallOption) (*RenderParameter, error) {
	out := new(RenderParameter)
	err := grpc.Invoke(ctx, "/operators.Operators/GetRenderParameters", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Operators_GetRenderParameters_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RenderParameterRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(OperatorsServer).GetRenderParameters(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/operators.Operators/GetRenderParameters",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OperatorsServer).GetRenderParameters(ctx, req.(*RenderParameterRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Operators_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Operators_GetRenderParameters_Handler,
		},
	},
...
var fileDescriptor0 = []byte{
	...
	,
}
